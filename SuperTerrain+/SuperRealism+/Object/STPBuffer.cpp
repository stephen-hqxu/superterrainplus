...
void* STPBuffer::mapBufferRange(STPOpenGL::STPintptr offset, STPOpenGL::STPsizeiptr length, STPOpenGL::STPbitfield access) {
	return glMapNamedBufferRange(this->Buffer.get(), offset, length, access);
}

void STPBuffer::flushMappedBufferRange(STPOpenGL::STPintptr offset, STPOpenGL::STPsizeiptr length) {
...
void STPBuffer::bufferStorage(STPOpenGL::STPsizeiptr size, STPOpenGL::STPbitfield flag) {
	this->bufferStorageSubData(nullptr, size, flag);
}

void STPBuffer::bufferSubData(const void* data, STPOpenGL::STPsizeiptr size, STPOpenGL::STPintptr offset) {
	glNamedBufferSubData(this->Buffer.get(), offset, size, data);
}

void STPBuffer::bufferStorageSubData(const void* data, STPOpenGL::STPsizeiptr size, STPOpenGL::STPbitfield flag) {
	glNamedBufferStorage(this->Buffer.get(), size, data, flag);
}

void STPBuffer::copyBufferSubDataFrom(const STPBuffer& readBuffer, STPOpenGL::STPintptr readOffset, STPOpenGL::STPintptr writeOffset, STPOpenGL::STPsizeiptr size) {
