...
__device__ static const It* lowerBound(const It* first, const It* last, T value, Comp&& comp) {
...
*/
template<class T>
__device__ __forceinline__ static const T* lowerBound(const T* first, const T* last, T value) {
