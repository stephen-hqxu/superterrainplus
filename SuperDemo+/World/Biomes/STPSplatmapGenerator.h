...
namespace STPDemo {
	...
	*/
	class STPSplatmapGenerator final : public SuperTerrainPlus::STPDiversity::STPTextureFactory, private STPCommonCompiler {
	private:
	...
	public:
		...
		*/
		STPSplatmapGenerator(const SuperTerrainPlus::STPDiversity::STPTextureDatabase::STPDatabaseView&, const SuperTerrainPlus::STPEnvironment::STPChunkSetting&);
